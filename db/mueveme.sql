...
INSERT INTO envios (url, titulo, entradilla, usuario_id, categoria_id, created_at)
    VALUES (
        ...
        2,
        1,
        current_timestamp - 'P2D'::interval
        ),
        (
        ...
        1,
        2,
        current_timestamp - 'P3D'::interval
        );

INSERT INTO comentarios (texto, usuario_id, envio_id, created_at)
    VALUES ('Me encanta la notica', 1, 1, current_timestamp - 'P1D'::interval)
         , ('Me gustaaa!', 2, 1, current_timestamp - 'P5D'::interval)
         , ('No me gusta la noticia', 2, 2, current_timestamp - 'P2D'::interval);
